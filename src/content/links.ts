...
export const REVIEW_CATALOG_URL = repoFile("docs/configuration.md#review-catalog");
export const REMEDIATION_MODES_URL = repoFile("docs/architecture.md#authenticated-remediation-review-modes");
export const FINDINGS_CONTRACTS_URL = repoFile("docs/findings-contracts.md");
...
export const NODE_RUNTIME_URL = repoFile("docs/node-runtime-contract.md");
export const RELEASE_READINESS_URL = repoFile("docs/release-readiness.md");
export const SQLITE_PERSISTENCE_URL = repoFile("docs/database/sqlite-persistence.md");
...
export const SOCKET_BADGE_URL = "https://badge.socket.dev/npm/package/garda-agent-orchestrator/1.4.2";
