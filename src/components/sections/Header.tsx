  ...
  return (
    <header className="sticky top-0 z-30 border-b border-white/8 bg-[#04070d]/65 backdrop-blur-2xl">
      <div className="mx-auto max-w-7xl px-6 py-4 lg:px-10">
        ...
        <nav className="mt-4 flex gap-2 overflow-x-auto pb-1 text-xs text-white/70 md:hidden">
          <ScrollButton targetId="why" className="shrink-0 rounded-full border border-white/10 bg-white/5 px-3 py-2 hover:text-white">Why</ScrollButton>
          <ScrollButton targetId="demo" className="shrink-0 rounded-full border border-white/10 bg-white/5 px-3 py-2 hover:text-white">Demo</ScrollButton>
          <ScrollButton targetId="workflow" className="shrink-0 rounded-full border border-white/10 bg-white/5 px-3 py-2 hover:text-white">Workflow</ScrollButton>
